  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-8 pb-10">
      <div className="flex flex-col gap-2">
        <h1 className="text-text-primary text-3xl font-black">Ajustes de Perfil</h1>
        ...
        <div className="flex-1 flex flex-col gap-4 text-center md:text-left">
          <div>
            <div className="flex items-center justify-center md:justify-start gap-3 mb-1">
              <h2 className="text-text-primary text-2xl font-bold">{formData.name || user?.name}</h2>
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-3">
            ...
            <button 
              onClick={triggerFileInput}
              className="px-4 h-9 bg-background-input border border-border-dark rounded-lg text-xs font-bold text-text-primary hover:bg-background-input/50 transition-all flex items-center gap-2"
            >
      ...
      <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
        <div className="bg-background-card rounded-2xl border border-border-dark overflow-hidden">
          <div className="p-6 border-b border-border-dark flex items-center gap-3">
            ...
            <h3 className="text-text-primary text-lg font-bold">Informações Pessoais</h3>
          </div>
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                className="h-12 bg-background-input border border-border-dark rounded-lg px-4 text-text-primary focus:ring-1 focus:ring-primary transition-all" 
              />
            </div>
            <div className="flex flex-col gap-2">
        ...
        {user?.profile !== 'Cliente' && (
          <div className="bg-background-card rounded-2xl border border-border-dark overflow-hidden">
            <div className="p-6 border-b border-border-dark flex items-center gap-3">
              ...
              <h3 className="text-text-primary text-lg font-bold">Dados do Sistema</h3>
            </div>
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
        ...
        <div className="bg-background-card rounded-2xl border border-border-dark overflow-hidden">
          <div className="p-6 border-b border-border-dark flex items-center gap-3">
            ...
            <h3 className="text-text-primary text-lg font-bold">Preferências</h3>
          </div>
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
